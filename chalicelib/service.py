...
from chalicelib.settings import S3_BUCKET_NAME, S3_OBJECT_KEY,AIRNOW_API_KEY, OWNER_ID

from time import localtime, sleep, strftime
from datetime import datetime as dt

def get_nodes_sensor_data(today):
    headers = {
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Safari/537.36",
        }
    response = requests.get(
        url="https://www.airnowapi.org/aq/data/?startDate={}T00&endDate={}T23&parameters=PM25,PM10&BBOX=-18.388062,-38.456014,52.979126,38.640199&dataType=C&format=application/json&verbose=1&nowcastonly=0&includerawconcentrations=1&API_KEY={}".format(today, today, AIRNOW_API_KEY), headers=headers)
    if not response.ok:
